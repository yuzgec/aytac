    ...
    @include('frontend.app.story')
         ...
         <div class="row">
             ...
             <div class="intro-banner-wrapper col-lg-3 mt-4">
                 <div class="banner banner-fixed intro-banner br-sm mb-4">
                     <figure class="br-sm">
                         <img src="/front/images/demos/demo12/banner/banner-1.jpg" alt="Category Banner"
         ...
         <div class="swiper-wrapper row cols-md-4 cols-sm-3 cols-1">
             <div class="swiper-slide icon-box icon-box-side text-dark">
                 ...
                 <div class="icon-box-content">
                     <h4 class="icon-box-title font-weight-bolder">Ücretsiz Kargo</h4>
                     <p class="text-default"> ₺ ve üzeri</p>
                 </div>
             </div>
             <div class="swiper-slide icon-box icon-box-side text-dark">
                 ...
                 <div class="icon-box-content">
                     <h4 class="icon-box-title font-weight-bolder">Güvenli Ödeme</h4>
                     <p class="text-default">PAYTR ile Güvenli Ödeme</p>
                 </div>
             </div>
             <div class="swiper-slide icon-box icon-box-side text-dark icon-box-money">
                 ...
                 <div class="icon-box-content">
                     <h4 class="icon-box-title font-weight-bolder">Ürün Kalitesi</h4>
                     <p class="text-default">Kaliteli Baskı ve Ürün </p>
                 </div>
             </div>
             <div class="swiper-slide icon-box icon-box-side text-dark icon-box-chat mt-0">
                 ...
                 <div class="icon-box-content">
                     <h4 class="icon-box-title font-weight-bolder">Müşteri Hizmetleri</h4>
                     <p class="text-default">7/24 Destek Hizmeti</p>
                 </div>
             </div>
         </div>
     </div>
     ...
     <div class="swiper-container swiper-theme select-product-wrapper shadow-swiper appear-animate pb-2 mb-10"
         ...
         <div class="swiper-wrapper row cols-lg-5 cols-md-4 cols-sm-3 cols-2">
             <div class="swiper-slide product product-image-gap product-simple">
                 <figure class="product-media">
                     <a href="product-default.html">
                         <img src="/front/images/demos/demo12/products/1-1-1.jpg" alt="Product" width="295"
                             height="335" />
                         <img src="/front/images/demos/demo12/products/1-1-2.jpg" alt="Product" width="295"
                             height="335" />
                     </a>
             ...
             <div class="swiper-slide product product-image-gap product-simple">
                 <figure class="product-media">
                     <a href="product-default.html">
                         <img src="/front/images/demos/demo12/products/1-2-1.jpg" alt="Product" width="295"
                             height="335" />
                         <img src="/front/images/demos/demo12/products/1-2-2.jpg" alt="Product" width="295"
                             height="335" />
                     </a>
                     <div class="product-action-vertical">
                         <a href="#" class="btn-product-icon btn-compare w-icon-compare" title="Compare"></a>
             ...
             <div class="swiper-slide product product-image-gap product-simple">
                 <figure class="product-media">
                     <a href="product-default.html">
                         <img src="/front/images/demos/demo12/products/1-3-1.jpg" alt="Product" width="295"
                             height="335" />
                         <img src="/front/images/demos/demo12/products/1-3-2.jpg" alt="Product" width="295"
                             height="335" />
                     </a>
                     <div class="product-action-vertical">
                         <a href="#" class="btn-product-icon btn-compare w-icon-compare" title="Compare"></a>
             ...
             <div class="swiper-slide product product-image-gap product-simple">
                 <figure class="product-media">
                     <a href="product-default.html">
                         <img src="/front/images/demos/demo12/products/1-4-1.jpg" alt="Product" width="295"
                             height="335" />
                         <img src="/front/images/demos/demo12/products/1-4-2.jpg" alt="Product" width="295"
                             height="335" />
                     </a>
                     <div class="product-action-vertical">
                         <a href="#" class="btn-product-icon btn-compare w-icon-compare" title="Compare"></a>
             ...
             <div class="swiper-slide product product-image-gap product-simple">
                 <figure class="product-media">
                     <a href="product-default.html">
                         <img src="/front/images/demos/demo12/products/1-5-1.jpg" alt="Product" width="295"
                             height="335" />
                         <img src="/front/images/demos/demo12/products/1-5-2.jpg" alt="Product" width="295"
                             height="335" />
                     </a>
                     <div class="product-action-vertical">
                         <a href="#" class="btn-product-icon btn-compare w-icon-compare" title="Compare"></a>
                 ...
                 <div class="vendor-widget-2">
                     <div class="vendor-details">
                         <figure class="vendor-logo">
                             <a href="vendor-dokan-store.html">
                                 <img src="/front/images/demos/demo12/vendor-logo/1.jpg" alt="Vendor Logo"
                                     width="70" height="70" />
                             </a>
                         </figure>
                     ...
                     <div class="vendor-products row cols-3 gutter-sm">
                         <div class="vendor-product">
                             <figure class="product-media">
                                 <a href="product-default.html">
                                     <img src="/front/images/demos/demo12/products/1-1-1.jpg"
                         ...
                         <div class="vendor-product">
                             <figure class="product-media">
                                 <a href="product-default.html">
                                     <img src="/front/images/demos/demo12/products/1-2-1.jpg"
                                         alt="Vendor Product" width="100" height="113" />
                                 </a>
                             </figure>
                         </div>
                         <div class="vendor-product">
                             <figure class="product-media">
                                 <a href="product-default.html">
                                     <img src="/front/images/demos/demo12/products/1-3-1.jpg"
                                         alt="Vendor Product" width="100" height="113" />
                                 </a>
                             </figure>
                         </div>
             ...
             <div class="swiper-slide vendor-widget mb-0">
                 <div class="vendor-widget-2">
                     <div class="vendor-details">
                         <figure class="vendor-logo">
                             <a href="vendor-dokan-store.html">
                                 <img src="/front/images/demos/demo12/vendor-logo/2.jpg" alt="Vendor Logo"
                                     width="70" height="70" />
                             </a>
                         </figure>
                         <div class="vendor-personal">
                     ...
                     <div class="vendor-products row cols-3 gutter-sm">
                         <div class="vendor-product">
                             <figure class="product-media">
                                 <a href="product-default.html">
                                     <img src="/front/images/demos/demo12/products/2-1-1.jpg"
                                         alt="Vendor Product" width="100" height="113" />
                                 </a>
                             </figure>
                         </div>
                         <div class="vendor-product">
                             <figure class="product-media">
                                 <a href="product-default.html">
                                     <img src="/front/images/demos/demo12/products/2-2-1.jpg"
                                         alt="Vendor Product" width="100" height="113" />
                                 </a>
                             </figure>
                         </div>
                         <div class="vendor-product">
                             <figure class="product-media">
                                 <a href="product-default.html">
                                     <img src="/front/images/demos/demo12/products/2-3-1.jpg"
                                         alt="Vendor Product" width="100" height="113" />
                                 </a>
                             </figure>
                         </div>
             ...
             <div class="swiper-slide vendor-widget mb-0">
                 <div class="vendor-widget-2">
                     <div class="vendor-details">
                         <figure class="vendor-logo">
                             <a href="vendor-dokan-store.html">
                                 <img src="/front/images/demos/demo12/vendor-logo/3.jpg" alt="Vendor Logo"
                                     width="70" height="70" />
                             </a>
                         </figure>
                         <div class="vendor-personal">
                     ...
                     <div class="vendor-products row cols-3 gutter-sm">
                         <div class="vendor-product">
                             <figure class="product-media">
                                 <a href="product-default.html">
                                     <img src="/front/images/demos/demo12/products/2-4-1.jpg"
                                         alt="Vendor Product" width="100" height="113" />
                                 </a>
                             </figure>
                         </div>
                         <div class="vendor-product">
                             <figure class="product-media">
                                 <a href="product-default.html">
                                     <img src="/front/images/demos/demo12/products/2-5-1.jpg"
                                         alt="Vendor Product" width="100" height="113" />
                                 </a>
                             </figure>
                         </div>
                         <div class="vendor-product">
                             <figure class="product-media">
                                 <a href="product-default.html">
                                     <img src="/front/images/demos/demo12/products/2-6-1.jpg"
                                         alt="Vendor Product" width="100" height="113" />
                                 </a>
                             </figure>
                         </div>
             ...
             <div class="swiper-slide vendor-widget mb-0">
                 <div class="vendor-widget-2">
                     <div class="vendor-details">
                         <figure class="vendor-logo">
                             <a href="vendor-dokan-store.html">
                                 <img src="/front/images/demos/demo12/vendor-logo/4.jpg" alt="Vendor Logo"
                                     width="70" height="70" />
                             </a>
                         </figure>
                         <div class="vendor-personal">
                     ...
                     <div class="vendor-products row cols-3 gutter-sm">
                         <div class="vendor-product">
                             <figure class="product-media">
                                 <a href="product-default.html">
                                     <img src="/front/images/demos/demo12/products/2-7-1.jpg"
                                         alt="Vendor Product" width="100" height="113" />
                                 </a>
                             </figure>
                         </div>
                         <div class="vendor-product">
                             <figure class="product-media">
                                 <a href="product-default.html">
                                     <img src="/front/images/demos/demo12/products/2-8-1.jpg"
                                         alt="Vendor Product" width="100" height="113" />
                                 </a>
                             </figure>
                         </div>
                         <div class="vendor-product">
                             <figure class="product-media">
                                 <a href="product-default.html">
                                     <img src="/front/images/demos/demo12/products/1-4-1.jpg"
                                         alt="Vendor Product" width="100" height="113" />
                                 </a>
                             </figure>
                         </div>
     ...
     <div class="banner-wrapper appear-animate row cols-md-2 mb-7">
         <div class="banner banner-fixed overlay-dark br-sm mt-4">
             <figure class="br-sm">
                 <img src="/front/images/demos/demo12/banner/banner-3.jpg" alt="Category Banner" width="680"
         ...
         <div class="banner banner-fixed overlay-dark br-sm mt-4">
             <figure class="br-sm">
                 <img src="/front/images/demos/demo12/banner/banner-4.jpg" alt="Category Banner" width="680"
         ...
         <div class="swiper-wrapper row cols-lg-2">
             <div class="swiper-slide ">
                 <div class="product product-list br-sm mb-0">
                     <figure class="product-media">
                         <a href="product-default.html">
                             <img src="/front/images/demos/demo12/products/1-1-1.jpg" alt="Product"
                                 width="315" height="355">
                             <img src="/front/images/demos/demo12/products/1-1-2.jpg" alt="Product"
                                 width="315" height="355">
                         </a>
                         <div class="product-action-vertical">
             ...
             <div class="swiper-slide ">
                 <div class="product product-list br-sm mb-0">
                     <figure class="product-media">
                         <a href="product-default.html">
                             <img src="/front/images/demos/demo12/products/1-4-1.jpg" alt="Product"
                                 width="315" height="355">
                             <img src="/front/images/demos/demo12/products/1-4-2.jpg" alt="Product"
                                 width="315" height="355">
                         </a>
                         <div class="product-action-vertical">
                             <a href="#" class="btn-product-icon btn-quickview w-icon-search"
             ...
             <div class="swiper-slide">
                 <div class="product-widget-wrap">
                     <div class="product product-widget">
                         <figure class="product-media">
                             <a href="product-default.html">
                                 <img src="/front/images/demos/demo12/products/2-1-1.jpg" alt="Product"
                                     width="100" height="106">
                                 <img src="/front/images/demos/demo12/products/2-1-2.jpg" alt="Product"
                                     width="100" height="106">
                             </a>
                         </figure>
                         <div class="product-details">
                 ...
                 <div class="product-widget-wrap">
                     <div class="product product-widget">
                         <figure class="product-media">
                             <a href="product-default.html">
                                 <img src="/front/images/demos/demo12/products/2-5-1.jpg" alt="Product"
                                     width="100" height="106">
                                 <img src="/front/images/demos/demo12/products/2-5-2.jpg" alt="Product"
                                     width="100" height="106">
                             </a>
                         </figure>
                         <div class="product-details">
             ...
             <div class="swiper-slide">
                 <div class="product-widget-wrap">
                     <div class="product product-widget">
                         <figure class="product-media">
                             <a href="product-default.html">
                                 <img src="/front/images/demos/demo12/products/2-2-1.jpg" alt="Product"
                                     width="100" height="106">
                                 <img src="/front/images/demos/demo12/products/2-2-2.jpg" alt="Product"
                                     width="100" height="106">
                             </a>
                         </figure>
                         <div class="product-details">
                 ...
                 <div class="product-widget-wrap">
                     <div class="product product-widget">
                         <figure class="product-media">
                             <a href="product-default.html">
                                 <img src="/front/images/demos/demo12/products/2-6-1.jpg" alt="Product"
                                     width="100" height="106">
                                 <img src="/front/images/demos/demo12/products/2-6-2.jpg" alt="Product"
                                     width="100" height="106">
                             </a>
                         </figure>
                         <div class="product-details">
             ...
             <div class="swiper-slide">
                 <div class="product-widget-wrap">
                     <div class="product product-widget">
                         <figure class="product-media">
                             <a href="product-default.html">
                                 <img src="/front/images/demos/demo12/products/2-3-1.jpg" alt="Product"
                                     width="100" height="106">
                                 <img src="/front/images/demos/demo12/products/2-3-2.jpg" alt="Product"
                                     width="100" height="106">
                             </a>
                         </figure>
                         <div class="product-details">
                 ...
                 <div class="product-widget-wrap">
                     <div class="product product-widget">
                         <figure class="product-media">
                             <a href="product-default.html">
                                 <img src="/front/images/demos/demo12/products/2-7-1.jpg" alt="Product"
                                     width="100" height="106">
                                 <img src="/front/images/demos/demo12/products/2-7-2.jpg" alt="Product"
                                     width="100" height="106">
                             </a>
                         </figure>
                         <div class="product-details">
             ...
             <div class="swiper-slide">
                 <div class="product-widget-wrap">
                     <div class="product product-widget">
                         <figure class="product-media">
                             <a href="product-default.html">
                                 <img src="/front/images/demos/demo12/products/2-4-1.jpg" alt="Product"
                                     width="100" height="106">
                                 <img src="/front/images/demos/demo12/products/2-4-2.jpg" alt="Product"
                                     width="100" height="106">
                             </a>
                         </figure>
                         <div class="product-details">
                 ...
                 <div class="product-widget-wrap">
                     <div class="product product-widget">
                         <figure class="product-media">
                             <a href="product-default.html">
                                 <img src="/front/images/demos/demo12/products/2-8-1.jpg" alt="Product"
                                     width="100" height="106">
                                 <img src="/front/images/demos/demo12/products/2-8-2.jpg" alt="Product"
                                     width="100" height="106">
                             </a>
                         </figure>
                         <div class="product-details">
